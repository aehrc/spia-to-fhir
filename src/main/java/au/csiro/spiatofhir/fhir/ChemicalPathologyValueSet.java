...
public class ChemicalPathologyValueSet implements SpiaFhirValueSet {
    ...
    private void buildValueSet() {
        ...
        valueSet.setId("spia-chemical-pathology-refset-3");
        valueSet.setUrl("https://www.rcpa.edu.au/fhir/ValueSet/spia-chemical-pathology-refset-3");
        ...
        valueSet.setName("RCPA - SPIA Chemical Pathology Terminology Reference Set v3.0");
        valueSet.setTitle("RCPA - SPIA Chemical Pathology Terminology Reference Set v3.0");
        valueSet.setDescription("Standard codes for use in reporting chemical pathology results in Australia.");
        SpiaFhirValueSet.addCommonElementsToValueSet(valueSet);
        valueSet.getText().getDiv().addText("RCPA - SPIA Chemical Pathology Terminology Reference Set v3.0");
