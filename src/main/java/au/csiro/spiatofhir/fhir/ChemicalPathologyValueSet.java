 ...
 * @author John Grimes
 */
public class ChemicalPathologyValueSet extends SpiaFhirValueSet {
  ...
  public Resource transform(Refset refset, Date publicationDate) {
    ...
    valueSet.setId(
        "spia-chemical-pathology-refset-" + Strings.majorVersionFromSemVer(valueSet.getVersion()));
    ...
    oid.setValue("urn:oid:1.2.36.1.2001.1004.300.100.1001");
    identifier.add(oid);
