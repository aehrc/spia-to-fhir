 ...
 * @author John Grimes
 */
public class RequestingValueSet extends SpiaFhirValueSet {

  private static final String NAME = "spia-requesting-refset";
  private static final String VERSION = "3.0.0";
  public static final String URL = "https://www.rcpa.edu.au/fhir/ValueSet/" + NAME + "-" + Strings
      .majorVersionFromSemVer(VERSION);
  private static final String OID = "1.2.36.1.2001.1004.300.100.1000";
