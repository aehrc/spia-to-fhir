...
public class ImmunopathologyValueSet extends SpiaFhirValueSet {
  ...
  public Resource transform(Refset refset, Date publicationDate) {
    ...
    valueSet.setId(
        "spia-immunopathology-refset-" + Strings.majorVersionFromSemVer(valueSet.getVersion()));
    valueSet.setUrl(
        "https://www.rcpa.edu.au/fhir/ValueSet/spia-immunopathology-refset-" + valueSet.getId());
