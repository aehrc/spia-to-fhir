 ...
 * @author John Grimes
 */
public abstract class ChemicalCombiningResultsMap {

  public static final String NAME = "spia-chemical-combining-results-map";
  public static final String TITLE = "RCPA - SPIA Chemical Combining Results Map";
  ...
  public static final String OID = "1.2.36.1.2001.1004.300.100.1003";
  public static final String DESCRIPTION =
      "Map between the SPIA Chemical Pathology Reference Set (v3.1) and the " +
