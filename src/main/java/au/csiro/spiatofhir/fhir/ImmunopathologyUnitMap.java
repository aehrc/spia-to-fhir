...
public class ImmunopathologyUnitMap {
    ...
    private void buildConceptMap() {
        ...
        conceptMap.setId("spia-immunopathology-unit-map-3");
        conceptMap.setUrl("https://www.rcpa.edu.au/fhir/ConceptMap/spia-immunopathology-unit-map-3");
        ...
        conceptMap.setName("RCPA - SPIA Immunopathology Unit Map v3.0");
        conceptMap.setTitle("RCPA - SPIA Immunopathology Unit Map v3.0");
        conceptMap.setDescription(
                "Map between the SPIA Immunopathology Reference Set and the corresponding RCPA preferred units for " +
                        "each code.");
        ...
        conceptMap.getText().getDiv().addText("RCPA - SPIA Immunopathology Unit Map v3.0");
        conceptMap.setSource(new UriType("https://www.rcpa.edu.au/fhir/ValueSet/spia-immunopathology-refset-3"));
