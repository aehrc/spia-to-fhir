 ...
 * @author John Grimes
 */
public abstract class HaematologyUnitMap {

  public static final String NAME = "spia-haematology-unit-map";
  ...
  public static final String OID = "1.2.36.1.2001.1004.300.100.1008";
  public static final String TITLE = "RCPA - SPIA Haematology Unit Map";
  public static final String DESCRIPTION =
      "Map between the SPIA Haematology Reference Set (v3.1) and the corresponding RCPA "
          + "preferred units (v1.1) for each code.";
  public static final String PURPOSE = "Resolving RCPA specified units for members of the SPIA Haematology Reference Set.";
}
