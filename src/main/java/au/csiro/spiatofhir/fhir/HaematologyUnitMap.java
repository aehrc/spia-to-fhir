...
public class HaematologyUnitMap extends SpiaFhirConceptMap {
  ...
  private static final String NAME = "spia-haematology-unit-map";
  private static final String VERSION = "2.0.0";
  public static final String URL = "https://www.rcpa.edu.au/fhir/ConceptMap/" + NAME + "-" + Strings
      .majorVersionFromSemVer(VERSION);
  private static final String OID = "1.2.36.1.2001.1004.300.100.1008";
  ...
  public Resource transform(Refset refset, Date publicationDate) {
    ...
    conceptMap.setPurpose(
        "Resolving RCPA specified units for members of the SPIA Haematology Reference Set.");
