...
public class LoincCodeValidatorTest extends TestCase {
    ...
    private static String[] validCodes = {"26924-1", "14682-9", "14933-6", "LL1001-8", "LP173485-6", "LA4108-2"};
    private static String[] invalidCodes = {"dog", "26dog5", "26dog5-4", "26924-2", "LA4108-3", "{14682-9}"};
